...
export function GoogleSignInButton() {
  ...
  return (
    <Button onClick={handleSignIn} variant="secondary" size="lg" className="w-full">
      <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden>
        ...
        <path
          fill="#4CAF50"
          d="M24 44c5.5 0 10.4-1.9 14.1-5.1l-6.5-5.5C29.6 35.4 26.9 36 24 36c-5.2 0-9.7-3.3-11.3-8l-6.6 5C9.9 39.7 16.4 44 24 44z"
        />
        <path
          fill="#1976D2"
          d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.2 4.2-4.1 5.6l6.5 5.5C41.5 36 44 30.6 44 24c0-1.2-.1-2.3-.4-3.5z"
        />
      </svg>
